...
const path = `src-tauri/target/release/bundle/nsis/Studysen_${latestData.version}_x64-setup.exe.sig`;
let signature = "";
...
latestData.platforms["windows-x86_64"] = {
    signature: signature,
    url: `https://github.com/appen-isen/studysen-desktop/releases/download/v${latestData.version}/Studysen_${latestData.version}_x64-setup.exe`
}
...
console.log(" - src-tauri/target/bundle/nsis/Studysen_" + latestData.version + "_x64-setup.exe");
